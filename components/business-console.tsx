...
export default function BusinessConsole({ module }: { module: Module }) {
  ...
  if (module === 'purchases') return <List title="Purchases" table="purchases" />
  if (module === 'inventory') return <List title="Inventory" table="v_inventory_current" />
  if (module === 'production') return <Dual title="Production" a="recipes" b="production_batches" al="Recipes" bl="Production batches" />
  if (module === 'orders') return <List title="Orders" table="orders" />
  if (module === 'sales') return <Dual title="Sales & Invoices" a="sales" b="invoices" al="Sales" bl="Invoices" />
