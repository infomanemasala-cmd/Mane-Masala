...
const SEARCH_COLUMNS: Record<string, string[]> = {
  ...
  v_order_production_plan: ['production_batch_code','output_item_code','output_item_name','ingredient_item_code','ingredient_item_name','status','wife_approval_status','recipe_version'],
  production_consumption: ['consumption_date','notes'],
  ...
  dispatches: ['business_code','dispatch_method','status','notes'],
  ...
  supplier_advances: ['advance_date','status','notes'], customer_advances: ['advance_date','status','notes'],
  stock_outs: ['business_code','stock_out_date','reason','notes'], stock_adjustments: ['business_code','adjustment_date','reason','notes'],
