...
export default function InventoryConsoleV5() {
  ...
  const submit = async () => {
    ...
    const success = kind === 'out' ? 'Stock Out recorded.' : 'Stock Adjustment recorded.'
    setRefreshToken(v => v + 1); closeForm(); setError(false); setMessage(success)
  }
