...
function blankLine(sequence_number: number): Line { return { ingredient_item_id: '', quantity: '', unit_id: '', sequence_number, notes: '' } }
...
function Panel({ title, children }: { title: string; children: ReactNode }) { return <div className="console-panel"><div className="panel-heading"><h3>{title}</h3></div>{children}</div> }
